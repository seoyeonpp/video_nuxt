<template>
  <div class="fixed top-0 left-0 right-0 bg-opacity-40 bg-black z-[999] w-[100vw] h-[100vh]">
    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="#ffffff" viewBox="0 0 256 256" class="animate-spin mr-3 absolute top-[50%] left-[50%]">
